...
<%--                        &lt;%&ndash;<a href="./ViewHome.html">&ndash;%&gt;--%>
...
<%--                                    &lt;%&ndash;<span>Trang chủ</span>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;</a>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;</div>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;<div class="nav-item p-2">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;<a href='<c:url value='/gioi-thieu'/>'>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;<span>Giới thiệu</span>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;&lt;%&ndash;<span style="color: var(--primary-color);">Giới thiệu</span>&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;</a>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;</div>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;<div class="nav-item p-2">&ndash;%&gt;--%>
...
<%--                                    &lt;%&ndash;&lt;%&ndash;<span style="color: var(--primary-color);">Sản phẩm</span>&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;</a>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;</div>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;<div class="nav-item p-2">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;<a class="nav-item-link" href="./TinTuc.html">&ndash;%&gt;&ndash;%&gt;--%>
